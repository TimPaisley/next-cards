import { faFistRaised, faSyncAlt, faWallet } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'

export default function Controls({ mana = 0, refresh, buyPhase = true, endTurn }) {
  return (
    <div className="py-4 flex space-x-4 align-middle justify-center">
      <div className="flex-1 flex items-center font-bold">
        <button
          ...
          <div className="w-4">
            <FontAwesomeIcon icon={buyPhase ? faWallet : faFistRaised} />
          </div>
        </button>
        Buy Phase
      </div>
